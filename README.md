...
For that reason I create this WebScraper bot, that it help me to get all lessons from different English levels and finally create a JSON format like this:
A1: {
    Chapter 1: Greeting{
        Description 1,
        Description 2,
